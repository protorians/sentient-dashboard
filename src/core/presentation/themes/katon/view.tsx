    ...
    return (
        <div className="relative max-w-screen w-full min-h-screen h-full">
            ...
            <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
                <div className="absolute aspect-square -top-[5%] -left-[5%] w-[30%] rounded-full bg-primary-500/10 blur-[120px]" />
                <div className="absolute aspect-square -top-[20%] -right-[20%] w-[45%] rounded-full bg-primary-500/10 blur-[150px]" />
                <div className="absolute aspect-square -bottom-[35%] right-[20%] w-[25%] rounded-full bg-primary-500/15 blur-[180px]" />
                {/*<motion.div*/}
                {/*    animate={{*/}
                {/*        x: [0, 80, -40, 0],*/}
                {/*        y: [0, -60, 40, 0],*/}
