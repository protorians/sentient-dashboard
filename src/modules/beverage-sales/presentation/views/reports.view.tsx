...
export default function ReportsView() {
    ...
    const breakdownChartConfig = {
        ...
        expenses: {label: "Dépenses", color: "var(--chart-4)"},
        profit: {label: "Bénéfice", color: "var(--chart-2)"},
    };
            ...
            <div className="flex flex-col gap-6 w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card className="border-none shadow-sm">
                        ...
                        <CardContent>
                            <div
                                className={`text-2xl font-bold ${profitColor}`}>{formatPrice(summary?.profit ?? 0)}</div>
                            <p className="text-xs text-muted-foreground mt-1">XOF</p>
                        </CardContent>
                    </Card>
                            ...
                            <ChartContainer config={breakdownChartConfig} className="h-[350px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <LineChart data={breakdown}>
                                        ...
                                        <Line type="monotone" dataKey="expenses" stroke="var(--chart-4)"
                                              strokeWidth={2} dot={false}/>
                                        <Line type="monotone" dataKey="profit" stroke="var(--chart-2)"
                                              strokeWidth={2} dot={false}/>
                                    </LineChart>
                                </ResponsiveContainer>
                            </ChartContainer>
                ...
                {topProducts.length > 0 && (
                    <Card className="border-none shadow-sm">
                        ...
                        <CardContent>
                            <TopProductsByProfitTable products={topProducts}/>
                        </CardContent>
                    </Card>
                )}
            </div>
